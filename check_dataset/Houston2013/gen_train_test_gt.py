...
for i in range(len(np.unique(data_tr))):
    print('No.{} train:{} val:{} train+val:{}'.format(i, np.sum(data_tr == i),
          np.sum(data_va == i), np.sum(data_tr == i)+np.sum(data_va == i)))
...
for i in range(len(np.unique(data_tr))):
    print('No.{} train:{} val:{} train+val:{}'.format(i, np.sum(data_tr == i),
          np.sum(data_va == i), np.sum(data_tr == i)+np.sum(data_va == i), np.sum(data_tr_va == i)))
